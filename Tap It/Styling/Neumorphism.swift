...
enum Neumorphic {
    static let defaultMainColor = Color(red: 238 / 255, green: 240 / 255, blue: 243 / 255, opacity: 1.000)
    static let defaultSecondaryColor = Color(red: 0.482, green: 0.502, blue: 0.549, opacity: 1.000)
    
    static let defaultBackgroundColor = Color(red: 229 / 255, green: 229 / 255, blue: 229 / 255)
